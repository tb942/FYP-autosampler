...
// Copyright (C) - 2018
//
// Modified by Thomas Butler in 2020
//    This modification adds PrintToLcd allowing text to wrap
//
//
...
void LiquidCrystal_I2C::PrintToLcd(String input) {
  String line1, line2;
  if (input.length() > 16) {
  ...
  if(line1 == previousLine1 && line2 == previousLine2){
    return;
  }
...
void LiquidCrystal_I2C::PrintToLcd(String line1, String line2) {
  if(line1 == previousLine1 && line2 == previousLine2){
    return;
  }
